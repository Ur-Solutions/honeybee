...
import { createHsrStopRecoveryDispatcher } from "./hsrStopRecovery.js";
...
export function buildDefaultDeps(options: BuildDefaultDepsOptions = {}): TickDeps {
  ...
  return {
    ...
    dispatchHsrStopRecovery: createHsrStopRecoveryDispatcher(),
    ...
    sampleUsage: createUsageSampler({ detached: true, sampleBudget: 25 }),
    ...
    sweepPools: createPoolSweeper({ detached: true }),
    reprobeTerminalCursors: createTerminalReprobeSweeper({ detached: true }),
